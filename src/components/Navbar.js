...
const Navbar = () => {
  ...
  const handleWhatsAppClick = () => {
    // Ganti dengan nomor WhatsApp admin Nagara Property yang sebenarnya
    const phoneNumber = '6282116000100'; // Format: 62 kode negara, tanpa '+' atau '0' di depan
    const defaultMessage = 'Halo Nagara Property, saya tertarik dengan properti Anda. Bisa dibantu informasi lebih lanjut?';
